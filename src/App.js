...
class App extends React.Component {
  ...
  render() {
    ...
    return <div>
      <header><Wynik />
        <nav><div id="tytul"><h1>Kalkulator Wynagrodzeń</h1><br/><h5><em>dla pracowników ze stawką godzinową<br />(uwzględnia urlop, pracę w dni wolne i świąteczne, pobyt na zwolnieniu lekarskim, dodatki, PPK, drugi próg podatkowy)</em></h5><br />
        </div>
        </nav>
      </header>
      <section><ol id="list">
